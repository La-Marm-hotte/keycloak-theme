...
<html>
<head>
    <title>Bienvenue à la Marm'hotte</title>
  ...
  <div class="row">
    <div class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2 col-lg-8 col-lg-offset-2">
      <div class="welcome-header">
        <img src="${resourcesPath}/img/logo.png" alt="La Marm'hotte" border="0" />
        <h1>Bienvenue à <strong>la Marm'hotte</strong></h1>
      </div>
      <div class="row">
        <div class="col-xs-12 col-sm-4">
          <div class="card-pf h-l">
            ...
            <#elseif errorMessage?has_content>
                ...
                <h3><img src="welcome-content/user.png">Console de gestion</h3>
            <#elseif bootstrap>
                <#if localUser>
                    <h3><img src="welcome-content/user.png">Console de gestion</h3>
            ...
            <#if bootstrap && localUser>
                <form method="post" class="welcome-form">
                    ...
                    <button id="create-button" type="submit" class="btn btn-primary">Créer</button>
                </form>
            </#if>
            <div class="welcome-primary-link">
              <h3><a href="${adminUrl}"><img src="welcome-content/user.png">Console de gestion <i class="fa fa-angle-right link" aria-hidden="true"></i></a></h3>
              <div class="description">
                Commissions <strong>gestion des membres</strong> et <strong>GSI</strong>
              </div>
            </div>
          </div>
        </div>
        <div class="col-xs-12 col-sm-4">
          <div class="card-pf h-l">
            <h3><a href="/auth/realms/master/account/"><img class="doc-img" src="${resourcesPath}/img/marmhotte_bleue.png">Espace membre <i class="fa fa-angle-right link" aria-hidden="true"></i></a></h3>
            <div class="description">

              Gérez votre <strong>compte personnel</strong> la Marm'hotte
